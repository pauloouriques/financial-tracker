 ...
 */
public class GetUsersTask extends AsyncTask<String, Void, Object> {
     ...
     */
    public GetUsersTask(final Context context, final ProgressBar progressBar, final OnTaskListener listener) {
    ...
    protected final Object doInBackground(final String... params) {
        try {
            Call<ArrayList<User>> call = new HttpRetrofitClient(mContext).mClient.getUsers();
