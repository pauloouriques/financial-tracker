 ...
 */
public class DeleteUserTask extends AsyncTask<User, Void, Object> {
     ...
     */
    public DeleteUserTask(Activity activity, OnTaskListener listener) {
    ...
    protected Object doInBackground(User... params) {
        try {
            ...
            Call<User> call;
            call = new HttpRetrofitClient(mActivity).mClient.removeUser(params[0]);
